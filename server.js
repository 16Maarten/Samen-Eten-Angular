...
//
const appname = "SamenEtenAngular";
...
const options = {
  setHeaders: (res, path, stat) => {
    res.set(
      ...
      "default-src 'self' https://samen-eten-angular.web.app/; script-src 'self' https://samen-eten-angular.web.app/; connect-src https://samen-eten-angular.web.app/ 'self'; img-src 'self' www.google.com; style-src 'self' 'unsafe-inline';"
    );
  },
};
